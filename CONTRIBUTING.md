...
Thank you for your interest in contributing to the Playful Sparkle Enhanced Measurement extension! We value contributions from the community to enhance this project for all users. Whether you're fixing bugs, adding features, improving documentation, or translating the extension, your efforts are greatly appreciated.
...
1. Review the [existing issues](https://github.com/playfulsparkle/oc4_enhanced_measurement/issues) to avoid duplicates.
...
- [GitHub Issues](https://github.com/playfulsparkle/oc4_enhanced_measurement/issues)
