...
$_['heading_setup']                         = 'Configuración de (GA4) Enhanced Measurement';
$_['heading_troubleshoot']                  = 'Solución de problemas comunes';
...
$_['text_contact']                          = '<p>Para más asistencia, por favor contacta con nuestro equipo de soporte:</p><ul><li><strong>Contacto:</strong> <a href="mailto:%s">%s</a></li><li><strong>Documentación:</strong> <a href="%s" target="_blank" rel="noopener noreferrer">Documentación del usuario</a></li></ul>';
...
$_['error_order_product_id']                = 'Advertencia: No se encontró el ID de producto asociado con este pedido.';
$_['error_request_parameters']              = 'Advertencia: Faltan o son incompletos los parámetros requeridos en la solicitud.';
