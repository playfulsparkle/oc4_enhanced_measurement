...
class PsEnhancedMeasurement extends \Opencart\System\Engine\Controller
{
    ...
    public function index(): void
    {
        ...
        $data['analytics_ps_enhanced_measurement_adwords_page_view_label'] = $this->config->get('analytics_ps_enhanced_measurement_adwords_page_view_label');
    ...
    public function eventAdminControllerSaleOrderAddHistoryAfter(string &$route, array &$args, string &$output = null)
    {
        ...
        if ($working_lead === 1) {
            $params = [
                'currency' => $currency,
                'value' => $this->currency->format($order_info['total'], $currency, 0, false),
